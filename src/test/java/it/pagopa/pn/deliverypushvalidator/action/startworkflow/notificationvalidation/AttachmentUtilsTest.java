...
import it.pagopa.pn.deliverypushvalidator.dto.legalfacts.StaticAarTemplateChooseStrategy;
...
import it.pagopa.pn.deliverypushvalidator.dto.timeline.details.AarCreationRequestDetailsInt;
...
class AttachmentUtilsTest {
    ...
    private NotificationInt getNotificationWithMultipleRecipients() {
        ...
        NotificationRecipientInt notificationRecipient1 = NotificationRecipientTestBuilder.builder()
                .withRecipientType(NotificationPaidInt.RecipientTypeInt.PF)
        ...
        NotificationRecipientInt notificationRecipient2 = NotificationRecipientTestBuilder.builder()
                .withRecipientType(NotificationPaidInt.RecipientTypeInt.PG)
