package it.pagopa.pn.deliverypushvalidator.middleware.externalclient.pnclient.deliverypush;
...
import static it.pagopa.pn.deliverypushvalidator.generated.openapi.msclient.delivery.model.NotificationFeePolicy.DELIVERY_MODE;
...
class PnDeliveryPushClientReactiveImplTest {
    ...
    void getNotificationProcessCost() {
        ...
        Mockito.verify(notificationProcessCostApi).notificationProcessCost(
                "testIun",
                0,
                it.pagopa.pn.deliverypushvalidator.generated.openapi.msclient.deliverypush.model.NotificationFeePolicy.DELIVERY_MODE,
                true,
                100,
                22
        );
