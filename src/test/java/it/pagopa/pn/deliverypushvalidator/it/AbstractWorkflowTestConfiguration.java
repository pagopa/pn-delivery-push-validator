package it.pagopa.pn.deliverypushvalidator.it;
...
import it.pagopa.pn.deliverypushvalidator.middleware.externalclient.pnclient.externalregistry.PnExternalRegistryClient;
import it.pagopa.pn.deliverypushvalidator.middleware.externalclient.pnclient.externalregistry.PnExternalRegistryClientImpl;
...
public class AbstractWorkflowTestConfiguration {
    ...
    @Bean
    public LegalFactGenerator legalFactGeneratorTemplatesClient(@Lazy PnSendModeUtils pnSendModeUtils, PnDeliveryPushValidatorConfigs pnDeliveryPushConfigs) {
