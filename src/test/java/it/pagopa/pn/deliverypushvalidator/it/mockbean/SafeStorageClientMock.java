...
import it.pagopa.pn.deliverypushvalidator.it.utils.MethodExecutor;
...
public class SafeStorageClientMock implements PnSafeStorageClient {
    ...
    public Mono<FileDownloadResponse> getFile(String fileKey, Boolean metadataOnly) {
        ...
        fileDownloadResponse.setChecksum(Base64.getEncoder().encodeToString( fileCreationWithContentRequest.getContent() ));
