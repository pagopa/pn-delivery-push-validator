...
public class NotificationRecipientTestBuilder {
    ...
    private NotificationPaidInt.RecipientTypeInt recipientType;
    ...
    public NotificationRecipientTestBuilder withRecipientType(NotificationPaidInt.RecipientTypeInt recipientType) {
