...
import it.pagopa.pn.deliverypushvalidator.dto.legalfacts.AarTemplateStrategyFactory;
import it.pagopa.pn.deliverypushvalidator.dto.legalfacts.DynamicRADDExperimentationChooseStrategy;
...
import it.pagopa.pn.deliverypushvalidator.service.mapper.TimelineMapperFactory;
import it.pagopa.pn.deliverypushvalidator.service.utils.PublicRegistryUtils;
import it.pagopa.pn.deliverypushvalidator.utils.*;
...
//ToDo: Le classi commentate vanno riportate?
...
//    NationalRegistriesClientMock nationalRegistriesClientMock;
    ...
    public void setup() {
        ...
        TestUtils.initializeAllMockClient(
                ...
                //nationalRegistriesClientMock,//ToDo: questo va riportato?
