...
public abstract class TimelineMapper {
    ...
    Instant findAARgenTimestamp(RecipientRelatedTimelineElementDetails elementDetails, Set<TimelineElementInternal> timelineElementInternalSet) {
        if (elementDetails == null) {
            throw new PnInternalException(ELEMENT_DETAILS_NULL, PnDeliveryPushValidatorExceptionCodes.ERROR_CODE_DELIVERYPUSH_TIMELINE_ELEMENT_NOT_PRESENT);
        }
        ...
        ).findFirst().orElseThrow(() -> new PnInternalException(SCHEDULE_REFINEMENT_NOT_PRESENT_ERROR_IN_MAPPING, PnDeliveryPushValidatorExceptionCodes.ERROR_CODE_DELIVERYPUSH_TIMELINE_ELEMENT_NOT_PRESENT));
    ...
    void caseRefinement(Set<TimelineElementInternal> timelineElementInternalSet, TimelineElementInternal result) {
        ...
        if (details != null) {
            ...
            throw new PnInternalException(SCHEDULE_REFINEMENT_NOT_PRESENT_ERROR_IN_MAPPING, PnDeliveryPushValidatorExceptionCodes.ERROR_CODE_DELIVERYPUSH_TIMELINE_ELEMENT_NOT_PRESENT);
        }
    }
