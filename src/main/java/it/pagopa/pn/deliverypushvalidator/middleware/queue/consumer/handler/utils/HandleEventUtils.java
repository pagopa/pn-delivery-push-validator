package it.pagopa.pn.deliverypushvalidator.middleware.queue.consumer.handler.utils;
...
import static it.pagopa.pn.deliverypushvalidator.exception.PnDeliveryPushValidatorExceptionCodes.ERROR_CODE_DELIVERYPUSH_HANDLEEVENTFAILED;
