package it.pagopa.pn.deliverypushvalidator.middleware.dao.documentcreationdao.dynamo;
...
public class DocumentCreationRequestEntityDaoDynamo extends AbstractDynamoKeyValueStore<DocumentCreationRequestEntity> implements DocumentCreationRequestEntityDao {
    ...
    protected DocumentCreationRequestEntityDaoDynamo(DynamoDbEnhancedClient dynamoDbEnhancedClient, PnDeliveryPushValidatorConfigs cfg) {
        super(dynamoDbEnhancedClient.table( tableName( cfg), TableSchema.fromClass(DocumentCreationRequestEntity.class)));
    }

    private static String tableName(PnDeliveryPushValidatorConfigs cfg ) {
