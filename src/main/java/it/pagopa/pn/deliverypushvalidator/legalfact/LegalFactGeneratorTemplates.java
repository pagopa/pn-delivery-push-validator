...
import it.pagopa.pn.deliverypushvalidator.dto.legalfacts.AARInfo;
import it.pagopa.pn.deliverypushvalidator.dto.legalfacts.AarTemplateChooseStrategy;
import it.pagopa.pn.deliverypushvalidator.dto.legalfacts.AarTemplateType;
...
import it.pagopa.pn.deliverypushvalidator.middleware.externalclient.pnclient.templatesengine.TemplatesClientPec;
...
import it.pagopa.pn.deliverypushvalidator.utils.QrCodeUtils;
...
import static it.pagopa.pn.deliverypushvalidator.exception.PnDeliveryPushValidatorExceptionCodes.ERROR_CODE_DELIVERYPUSH_CONFIGURATION_NOT_FOUND;
import static it.pagopa.pn.deliverypushvalidator.exception.PnDeliveryPushValidatorExceptionCodes.ERROR_CODE_DELIVERYPUSH_INVALID_TEMPLATE;
import static it.pagopa.pn.deliverypushvalidator.service.mapper.TemplatesEngineMapper.*;
...
public class LegalFactGeneratorTemplates implements LegalFactGenerator {
    ...
    private String getAccessUrl(NotificationRecipientInt recipient) {
        return NotificationPaidInt.RecipientTypeInt.PF == recipient.getRecipientType()
