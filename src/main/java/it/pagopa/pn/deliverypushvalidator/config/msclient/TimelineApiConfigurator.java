...
import it.pagopa.pn.deliverypushvalidator.generated.openapi.msclient.timelineservice.ApiClient;
...
public class TimelineApiConfigurator {
    @Bean
    @Primary
    public TimelineControllerApi timelineControllerApi(@Qualifier("withTracing") RestTemplate restTemplate, PnDeliveryPushValidatorConfigs cfg){
