...
import it.pagopa.pn.deliverypushvalidator.generated.openapi.msclient.delivery.ApiClient;
...
public class DeliveryApiConfigurator {
    @Bean
    @Primary
    public InternalOnlyApi internalOnlyApi(@Qualifier("withTracing") RestTemplate restTemplate, PnDeliveryPushValidatorConfigs cfg){
